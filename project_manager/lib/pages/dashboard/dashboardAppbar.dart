...
class DashboardAppbar extends StatelessWidget implements PreferredSizeWidget {
  ...
  // Constructor
  const DashboardAppbar({super.key, this.user});
  ...
  Widget build(BuildContext context) {
    ...
    final Widget trailing = Icon(Icons.settings);

    // TODO: Add onTap callbacks for leading and trailing
    return CustomAppBar(title: title, leading: leading, trailing: trailing);
  }
}
